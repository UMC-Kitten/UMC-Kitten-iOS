...
class HealthBookViewController: UIViewController {
    ...
    func setupNeedleView() {
        ...
        NSLayoutConstraint.activate([
            ...
            customView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 75),
    ...
    func setupNeedleTwoView() {
        ...
        NSLayoutConstraint.activate([
            ...
            customTwoView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 75),
