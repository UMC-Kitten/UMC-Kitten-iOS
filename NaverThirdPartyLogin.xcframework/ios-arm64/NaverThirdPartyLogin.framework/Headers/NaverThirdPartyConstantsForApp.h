...
#define kServiceAppUrlScheme    @"naverq4yYq9GqZvWRQnbf8S1h"

#define kConsumerKey            @"q4yYq9GqZvWRQnbf8S1h"
#define kConsumerSecret         @"NtgmBYXHHQ"
#define kServiceAppName         @"Kitten"
